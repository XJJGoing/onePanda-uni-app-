...
<script>
	...
	import {User} from  '@/static/js/Utils.js' //User工具类
	var app = getApp()
	export default { 
		data() { 
			return {
				 ...
				 uni.getSetting({
				 	success(res){
				 		if(res.authSetting['scope.userInfo']){
							...
							.then(res => {
								userInfo = res;
								console.log("老师登陆的信息",code,userInfo,_this.username,_this.password,1)
								return User.userLogin(code,userInfo,_this.username,_this.password,1)
							}) 
